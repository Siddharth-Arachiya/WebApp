...
socketio = SocketIO(app, cors_allowed_origins="*",
                    ping_timeout=20, ping_interval=2)
...
def start():
    ...
    try:
        req_str = "https://aequm99.myshopify.com/admin/api/2021-04/products/" + \
            glass + ".json?fields=title,body_html,variants"
        response1 = requests.get(req_str, auth=(
            '5997eeb2ea13036b59f25dd280f73025', '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'))
    ...
    return render_template('demoIndex1.html', title=title, brand=brand, desc=desc, price=price, cart=cart, vid = vid, pid = glass)
...
def image(arr):
    ...
    if data_image == "None":
        ...
        r.setex(arr[2], timedelta(minutes=10),
                value=im_bytes)
